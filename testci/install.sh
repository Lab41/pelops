...
# Taken from: https://github.com/aabadie/nilearn/blob/circle_ci_anaconda/continuous_integration/install.sh
#
...
create_new_conda_env() {
    ...
    # itself
    wget https://repo.continuum.io/miniconda/Miniconda-3.5.2-Linux-x86_64.sh \
        -O ~/miniconda.sh
